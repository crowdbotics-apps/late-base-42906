"""
Django settings for late_base_42906 project.
...
ROOT_URLCONF = 'late_base_42906.urls'
...
WSGI_APPLICATION = 'late_base_42906.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_base_42906 API",
    "DESCRIPTION": "API documentation for late_base_42906 App",
    "VERSION": "v1",
}
